...
const vec4 T1_COLOR = vec4(.502, 0.98, 1., 1.0);
const vec4 T1_ACCENT = vec4(.0, 0., 1., 1.0);
const float DURATION_1 = 0.3;

// Color Set 2 (Reverted to Orange/Red)
const vec4 T2_COLOR = vec4(1.0, 0.725, 0.161, 1.0);
const vec4 T2_ACCENT = vec4(1.0, 0., 0., 1.0);
